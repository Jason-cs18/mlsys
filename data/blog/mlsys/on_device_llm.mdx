...
## Citation
Cited as:
> Lu, Yan. (Nov 2024). On-Device Large Language Models. Yan'Log. https://jason-cs18.github.io/mlsys/blog/mlsys/on_device_llm.

or

```latex
@article{lu2024devicellm,
  title   = "On-Device Large Language Models.",
  author  = "Lu, Yan",
  journal = "https://jason-cs18.github.io/mlsys/",
  year    = "2024",
  month   = "Nov",
  url     = "https://jason-cs18.github.io/mlsys/blog/mlsys/on_device_llm"
}
```
