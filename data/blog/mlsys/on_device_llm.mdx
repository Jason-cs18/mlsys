...
---
Deploying language models (LLMs) on devices is gaining significant attention due to the increasing demand for accessibility and privacy. This field is seeing two main trends: one involves creating smaller versions of LLMs, while the other focuses on designing efficient systems to run LLMs on devices.
...
|:--:|:---:|:---:|:---:|:---:|
|[`llama.cpp`](https://github.com/ggerganov/llama.cpp)![Github stars](https://img.shields.io/github/stars/ggerganov/llama.cpp.svg)![Github forks](https://img.shields.io/github/forks/ggerganov/llama.cpp.svg)|NVIDIA GPU, Intel CPU, Apple silicon, Android|:---:|:---:|:---:|
|[`PowerInfer`](https://github.com/SJTU-IPADS/PowerInfer)![Github stars](https://img.shields.io/github/stars/SJTU-IPADS/PowerInfer.svg)![Github forks](https://img.shields.io/github/forks/SJTU-IPADS/PowerInfer.svg)|:---:|:---:|:---:|:---:|
