...
A simple RAG depends on the searched context. However, the context is not always retrieved correctly due to inaccurate questions. To address this issue, we can use Agentic RAG to improve the performance of RAG. Agentic RAG is a framework that enables LLMs to reformulate their queries and self-query to improve the performance of RAG.
## Challenges for RAG
